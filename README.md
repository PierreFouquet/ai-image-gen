...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/ai-image-gen)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/ai-image-gen
```

A live public deployment of this template is available at [https://ai-image-gen.templates.workers.dev](https://ai-image-gen.templates.workers.dev)
